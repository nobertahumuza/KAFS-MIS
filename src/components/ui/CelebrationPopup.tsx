...
interface CelebrationPopupProps {
  open: boolean
  onClose: () => void
  type: "deposit" | "withdrawal" | "loan" | "share" | "fixed" | "repayment"
  amount: number
  balance?: number
  reference?: string
  charges?: number
...
const config = {
  ...
  repayment: {
    ...
    emoji: "✅",
    msg: "Your loan repayment has been processed successfully.",
  },
}
...
export default function CelebrationPopup({ open, onClose, type, amount, balance, reference, charges, message }: CelebrationPopupProps) {
    ...
    <>
      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">{message || cfg.msg}</p>
